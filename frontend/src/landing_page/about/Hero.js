...
function Hero() {
    return (
        <div className='container'>
            ...
            <hr />
            <div className='row mt-4 p-2 p-md-5 text-muted' style={{ fontSize: "1.2em", lineHeight: "2" }}>
                ...
                <div className='col-12 col-md-6 p-3 p-md-4'>
                    ...
                    <p>
                        <a href='#' className='text' style={{ textDecoration: "none" }}>Rainmatter,</a> our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.
                    </p>
                    <p>
